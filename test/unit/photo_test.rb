...
class PhotoTest < Test::Unit::TestCase
  ...
  def test_should_upload_photo_and_create_thumbnails
    photo_object = upload_file 'logo.png', users(:valid_user)
    assert_file_exists photo_object.id, "logo.png"
    assert_file_exists photo_object.id, "logo_thumb.png"
  end
  
  def test_should_delete_db_row_and_files
    photo_object = upload_file 'emoticon.png', users(:valid_user)
    ...
    assert_file_does_not_exist photo_object.id, "logo.png"
    assert_file_does_not_exist photo_object.id, "logo.png"
  end
